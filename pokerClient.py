...
while True:
  sleep(1)  
  try:
    deal = getRequest("http://nolimitcodeem.com/sandbox/players/"+key)
    reset()

    print deal

    print deal['your_turn']
    print deal['betting_phase']
    ...
    if phase == "deal":
      ...
      print "Error: What betting state are you?"
    ...
    print "Moving ", move
    act = postRequest("http://nolimitcodeem.com/sandbox/players/"+key+"/action", move)
